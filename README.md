...
* Седьмой пункт выполняет восстановление БД из файла бэкапа
* Восьмой пункт выполняет восстановление TeamCity из бэкапа
* Девятый пункт осуществляет рестрат сервисов
